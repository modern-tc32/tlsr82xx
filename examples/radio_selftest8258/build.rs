...
fn main() {
    ...
    let rf_drv_obj = drivers_dir.join("rf_drv.o");
    let bsp_obj = drivers_dir.join("bsp.o");
    println!("cargo:rerun-if-changed={}", rf_drv_obj.display());
    println!("cargo:rerun-if-changed={}", bsp_obj.display());
    ...
    println!("cargo:rustc-link-arg={}", bsp_obj.display());
    println!("cargo:rustc-link-arg={}", rf_drv_obj.display());
}

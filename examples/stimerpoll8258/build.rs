...
fn main() {
    ...
    let include_dirs = [common_dir.join("include"), manifest_dir.join("support")];
    ...
    let sources = [
        ...
        manifest_dir.join("support/vendor_irq_entry_8258.S"),
        manifest_dir.join("support/vendor_irq_handler.c"),
    ];

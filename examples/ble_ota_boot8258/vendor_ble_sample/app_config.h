...
#define BLE_APP_SECURITY_ENABLE      					0	// force undirected advertising for OTA bring-up
...
#define APP_CONTR_EVENT_LOG_EN				0  //controller event log
#define APP_HOST_EVENT_LOG_EN				0  //host event log
...
/////////////////////// Sample Board Select Configuration ///////////////////////////////
	...
	//8258 sample board selection
	#define BOARD_SELECT							BOARD_825X_TB_03F

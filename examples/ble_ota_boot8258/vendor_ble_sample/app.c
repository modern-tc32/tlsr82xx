...
const u8	tbl_advData[] = {
	 2,  DT_FLAGS, 0x06, // LE General Discoverable Mode + BR/EDR not supported
	 17, DT_COMPLETE_LIST_128BIT_SERVICE_UUID, TELINK_OTA_UUID_SERVICE,
	 9,  DT_COMPLETE_LOCAL_NAME, 'T', 'L', 'S', 'R', ' ', 'O', 'T', 'A',
};
...
const u8	tbl_scanRsp [] = {
	 4, DT_SHORTENED_LOCAL_NAME, 'O', 'T', 'A',
};
...
#if(BLE_APP_PM_ENABLE)
	/* OTA bring-up: keep radio continuously discoverable, avoid ADV/retention sleep transitions. */
	return;
...
//////////////////////////// BLE stack Initialization  Begin //////////////////////////////////
	...
	/* OTA bring-up: use deterministic random static address for stable scanning/debugging. */
	{
		u8 fixed_random_static[6] = {0x01, 0x00, 0x58, 0x82, 0xDE, 0xC0}; /* C0:DE:82:58:00:01 */
		app_own_address_type = OWN_ADDRESS_RANDOM;
		blc_ll_setRandomAddr(fixed_random_static);
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/* Bring-up mode: keep running even if internal init check reports non-fatal mismatch. */
